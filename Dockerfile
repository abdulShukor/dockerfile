...
RUN rm -rf 2131_wedding_lite 2131_wedding_lite.zip
RUN wget  https://templatemo.com/tm-zip-files-2020/templatemo_580_woox_travel.zip
RUN unzip templatemo_580_woox_travel
RUN cd templatemo_580_woox_travel && tar cvzf templatemo_580_woox_travel.tar.gz  *
RUN ls
